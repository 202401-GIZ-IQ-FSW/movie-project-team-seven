  ...
  const poster = imagePath + movie.poster_path;
        return( 
          <Link key={movie.id} href={"/movies/" + movie.id } >
            <div className="group hover:scale-[105%] relative h-[300px] w-[150px] text-black text-[12px] flex justify-center items-end hover:items-center gap-8 md:hover:bg-[rgb(27,27,27,0.5)] border hover:border-cyan-400">
