      ...
      <div className='flex flex-col justify-center items-center font-serif'>
        <div className='relative text-white w-[calc(100%-30px)] mx-auto my-8 flex justify-center items-start flex-col sm:flex-row gap-4'>
          ...
          <div className="m-4 sm:max-w-[70%] sm:mx-auto flex flex-col gap-4">
            ...
            <p className='border-b border-cyan-700 py-4 md:text-[18px]'><span className='text-cyan-500'>Overview:</span> {movieInfo.overview}</p>
          ...
          <div className="w-full mx-auto text-left">
            ...
            {(similarMovies.length > 0)? <CustomSlider Movies={similarMovies}/> : <p className='text-cyan-400 m-4'>No similar movies provided from the API</p>}
            </div>
          </div>
      </div>
    </Suspense>
